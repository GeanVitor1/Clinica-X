...
public class ServicoRepository : IServicoRepository
{
    ...
    public async Task AddAsync(Servico servico, CancellationToken ct = default) => await _context.Set<Servico>().AddAsync(servico, ct);
    public Task UpdateAsync(Servico servico, CancellationToken ct = default) { _context.Set<Servico>().Update(servico); return Task.CompletedTask; }
    public Task DeleteAsync(Servico servico, CancellationToken ct = default) { _context.Set<Servico>().Remove(servico); return Task.CompletedTask; }
}
